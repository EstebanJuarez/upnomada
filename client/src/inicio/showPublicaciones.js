  ...
  function CompShowPublicaciones() {
    ...
    //FIXME: crear el mostar todas las publicaciones
    ...
    return (
      <>
        ...
        <div className="p-16 flex flex-col items-center">
          ...
          <Link    onClick={() => setIsModalOpen(true)}  to={shouldModalOpen ? "#" : "/publicaciones" }  className="mt-4 bg-jaune hover:bg-bleu hover:text-white transition-all text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
            Ver todas
          </Link>
        </div>
